...
# Adaptez selon vos besoins (plusieurs parties, config dynamique, etc.).
...
def init_game():
    """
    Ré-initialise la partie : recrée la grille initiale.
    """
    game_manager.reset()
    return {"message": "Game re-initialized", "grid": game_manager.get_state()}